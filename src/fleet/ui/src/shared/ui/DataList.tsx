...
export interface DataColumn<T> {
  key: string;
  header: ReactNode;
  /** Fixed column width (rem); omit for the fill column. */
  width?: string;
...
// Desktop table row built from the column definitions.
function DataRow<T>({
  columns,
  row,
  selected,
  ...
  return (
    <div style={R.rowStyle(selected)} className="row-interactive" {...click}>
      {columns.map((col) => (
