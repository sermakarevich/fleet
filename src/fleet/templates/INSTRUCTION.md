...
Read `PLAN.md`, `HANDOFF.md`, then `KNOWLEDGE.md` under `$FLEET_ARTIFACT_DIR`. Never read `events.jsonl`, `log.jsonl`, `log.stderr`, or anything under `attempts/` — they are for humans and tooling, not for you.
